...
//    ui->setupUi();
    ...
    for (int i=0;i<12;i++)
    {
        ...
        threeDay[i]=d->queryCountsAccordingCardNumAndTime(tr("%1").arg(tmp),dateSeries.at(2));
    }
        ...
        QBarSet *set2 = new QBarSet(dateSeries.at(2));
        ...
        *set2 << threeDay[0] << threeDay[1] << threeDay[2] << threeDay[3] << threeDay[4] << threeDay[5] << threeDay[6] << threeDay[7] << threeDay[8] << threeDay[9] << threeDay[10] << threeDay[11] ;
